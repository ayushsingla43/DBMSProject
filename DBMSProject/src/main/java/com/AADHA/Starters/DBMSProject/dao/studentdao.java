...
public class studentdao {
    ...
    public void insertStudent(String std_name, String std_gender, String std_date, Integer std_pin, String std_mother, String std_guardian, Integer std_class, Integer std_section, String std_dob, String std_email, String std_bg, String std_phone1, String std_phone2, String std_street, String std_city, String std_state, String std_aadhar, String password){
        String sql = "insert into student(name, gender, phone_1, phone_2, DOB, admission_date, email, blood_grp, guardian, mother, PIN, street, city,Aadhar_no, state, password, class_no, " + "section_no) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        jdbc.update(sql, std_name, std_gender , std_phone1, std_phone2, std_dob, std_date, std_email, std_bg, std_guardian, std_mother, std_pin, std_street, std_city, std_aadhar, std_state,password, std_class, std_section);
    ...
    public void editStudent(String UID,String std_name, String std_gender, String std_date, Integer std_pin, String std_mother, String std_guardian, Integer std_class, Integer std_section, String std_dob, String std_email, String std_bg, String std_phone1, String std_phone2, String std_street, String std_city, String std_state, String std_aadhar){
        System.out.println(std_gender);
        System.out.println(std_gender.length());
        String sql = "update student set name=?,gender=?, phone_1=?, phone_2=?, DOB=?, admission_date=?, email=?, blood_grp=?, guardian=?, mother=?, PIN=?, street=?, city=?,Aadhar_no=?, state=?, class_no=?, " + "section_no=? where UID=?";
        jdbc.update(sql, std_name, std_gender , std_phone1, std_phone2, std_dob, std_date, std_email, std_bg, std_guardian, std_mother, std_pin, std_street, std_city, std_aadhar, std_state, std_class, std_section,UID);
    }
